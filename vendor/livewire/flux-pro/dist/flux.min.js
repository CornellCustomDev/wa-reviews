(()=>{var st=class extends Event{oldState;newState;constructor(t,{oldState:e="",newState:i="",...s}={}){super(t,s),this.oldState=String(e||""),this.newState=String(i||"")}},Mi=new WeakMap;function Ni(t,e,i){Mi.set(t,setTimeout(()=>{Mi.has(t)&&t.dispatchEvent(new st("toggle",{cancelable:!1,oldState:e,newState:i}))},0))}var Dt=globalThis.ShadowRoot||function(){},Rs=globalThis.HTMLDialogElement||function(){},Je=new WeakMap,Q=new WeakMap,Fe=new WeakMap;function Ze(t){return Fe.get(t)||"hidden"}var et=new WeakMap;function Is(t){let e=t.popoverTargetElement;if(!(e instanceof HTMLElement))return;let i=Ze(e);t.popoverTargetAction==="show"&&i==="showing"||t.popoverTargetAction==="hide"&&i==="hidden"||(i==="showing"?De(e,!0,!0):de(e,!1)&&(et.set(e,t),Mt(e)))}function de(t,e){return!(t.popover!=="auto"&&t.popover!=="manual"||!t.isConnected||e&&Ze(t)!=="showing"||!e&&Ze(t)!=="hidden"||t instanceof Rs&&t.hasAttribute("open")||document.fullscreenElement===t)}function Di(t){return t?Array.from(Q.get(t.ownerDocument)||[]).indexOf(t)+1:0}function Ns(t){let e=Wi(t),i=Ws(t);return Di(e)>Di(i)?e:i}function tt(t){let e=Q.get(t);for(let i of e||[])if(!i.isConnected)e.delete(i);else return i;return null}function xe(t){return typeof t.getRootNode=="function"?t.getRootNode():t.parentNode?xe(t.parentNode):t}function Wi(t){for(;t;){if(t instanceof HTMLElement&&t.popover==="auto"&&Fe.get(t)==="showing")return t;if(t=t instanceof Element&&t.assignedSlot||t.parentElement||xe(t),t instanceof Dt&&(t=t.host),t instanceof Document)return}}function Ws(t){for(;t;){let e=t.popoverTargetElement;if(e instanceof HTMLElement)return e;if(t=t.parentElement||xe(t),t instanceof Dt&&(t=t.host),t instanceof Document)return}}function Hs(t){let e=new Map,i=0;for(let n of Q.get(t.ownerDocument)||[])e.set(n,i),i+=1;e.set(t,i),i+=1;let s=null;function o(n){let r=Wi(n);if(r===null)return null;let c=e.get(r);(s===null||e.get(s)<c)&&(s=r)}return o(t.parentElement||xe(t)),s}function qs(t){return t.hidden||t instanceof Dt||(t instanceof HTMLButtonElement||t instanceof HTMLInputElement||t instanceof HTMLSelectElement||t instanceof HTMLTextAreaElement||t instanceof HTMLOptGroupElement||t instanceof HTMLOptionElement||t instanceof HTMLFieldSetElement)&&t.disabled||t instanceof HTMLInputElement&&t.type==="hidden"||t instanceof HTMLAnchorElement&&t.href===""?!1:typeof t.tabIndex=="number"&&t.tabIndex!==-1}function Bs(t){if(t.shadowRoot&&t.shadowRoot.delegatesFocus!==!0)return null;let e=t;e.shadowRoot&&(e=e.shadowRoot);let i=e.querySelector("[autofocus]");if(i)return i;{let n=e.querySelectorAll("slot");for(let r of n){let c=r.assignedElements({flatten:!0});for(let a of c){if(a.hasAttribute("autofocus"))return a;if(i=a.querySelector("[autofocus]"),i)return i}}}let s=t.ownerDocument.createTreeWalker(e,NodeFilter.SHOW_ELEMENT),o=s.currentNode;for(;o;){if(qs(o))return o;o=s.nextNode()}}function zs(t){Bs(t)?.focus()}var it=new WeakMap;function Mt(t){if(!de(t,!1))return;let e=t.ownerDocument;if(!t.dispatchEvent(new st("beforetoggle",{cancelable:!0,oldState:"closed",newState:"open"}))||!de(t,!1))return;let i=!1;if(t.popover==="auto"){let o=t.getAttribute("popover"),n=Hs(t)||e;if(ot(n,!1,!0),o!==t.getAttribute("popover")||!de(t,!1))return}tt(e)||(i=!0),it.delete(t);let s=e.activeElement;t.classList.add(":popover-open"),Fe.set(t,"showing"),Je.has(e)||Je.set(e,new Set),Je.get(e).add(t),zs(t),t.popover==="auto"&&(Q.has(e)||Q.set(e,new Set),Q.get(e).add(t),Hi(et.get(t),!0)),i&&s&&t.popover==="auto"&&it.set(t,s),Ni(t,"closed","open")}function De(t,e=!1,i=!1){if(!de(t,!0))return;let s=t.ownerDocument;if(t.popover==="auto"&&(ot(t,e,i),!de(t,!0))||(Hi(et.get(t),!1),et.delete(t),i&&(t.dispatchEvent(new st("beforetoggle",{oldState:"open",newState:"closed"})),!de(t,!0))))return;Je.get(s)?.delete(t),Q.get(s)?.delete(t),t.classList.remove(":popover-open"),Fe.set(t,"hidden"),i&&Ni(t,"open","closed");let o=it.get(t);o&&(it.delete(t),e&&o.focus())}function Fi(t,e=!1,i=!1){let s=tt(t);for(;s;)De(s,e,i),s=tt(t)}function ot(t,e,i){let s=t.ownerDocument||t;if(t instanceof Document)return Fi(s,e,i);let o=null,n=!1;for(let r of Q.get(s)||[])if(r===t)n=!0;else if(n){o=r;break}if(!n)return Fi(s,e,i);for(;o&&Ze(o)==="showing"&&Q.get(s)?.size;)De(o,e,i)}var Tt=new WeakMap;function Ri(t){if(!t.isTrusted)return;let e=t.composedPath()[0];if(!e)return;let i=e.ownerDocument;if(!tt(i))return;let o=Ns(e);if(o&&t.type==="pointerdown")Tt.set(i,o);else if(t.type==="pointerup"){let n=Tt.get(i)===o;Tt.delete(i),n&&ot(o||i,!1,!0)}}var Ot=new WeakMap;function Hi(t,e=!1){if(!t)return;Ot.has(t)||Ot.set(t,t.getAttribute("aria-expanded"));let i=t.popoverTargetElement;if(i instanceof HTMLElement&&i.popover==="auto")t.setAttribute("aria-expanded",String(e));else{let s=Ot.get(t);s?t.setAttribute("aria-expanded",s):t.removeAttribute("aria-expanded")}}var Ii=globalThis.ShadowRoot||function(){};function Vs(){return typeof HTMLElement<"u"&&typeof HTMLElement.prototype=="object"&&"popover"in HTMLElement.prototype}function he(t,e,i){let s=t[e];Object.defineProperty(t,e,{value(o){return s.call(this,i(o))}})}var $s=/(^|[^\\]):popover-open\b/g;function js(){return typeof globalThis.CSSLayerBlockRule=="function"}function Gs(){let t=js();return`
