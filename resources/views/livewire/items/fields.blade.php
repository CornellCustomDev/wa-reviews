<x-cd.form.text label="Description" wire:model="form.description" description="(Observed functionality)" />
...
<x-cd.form.checkbox-inline label="Content entry issue" :value="true" wire:model="form.content_issue"/>
