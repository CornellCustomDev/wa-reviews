...
## Task
Find the Guidelines that apply to the user-reported issue and return them in the specified format of issues. A
...
1. When one or more guidelines are applicable to an accessibility issue, return an `issues` array containing an object
...
explanation (and, if helpful, alternative resources). Do not include `issues` in this case.
