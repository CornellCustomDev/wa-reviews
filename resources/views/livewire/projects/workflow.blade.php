        ...
        <form class="mb-0!">
            ...
            <div class="mt-8">
                @if($this->nextActionLabel)
                    <x-forms.button
                        wire:click="updateStatus('next')">{{ $this->nextActionLabel }}</x-forms.button>
                @endif
                @if($this->previousActionLabel)
                    <x-forms.button wire:click="updateStatus('previous')"
                                    class="secondary">{{ $this->previousActionLabel }}</x-forms.button>
                @endif
            </div>
        </form>
    </flux:modal>
