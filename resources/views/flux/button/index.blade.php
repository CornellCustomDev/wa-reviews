...
$classes = Flux::classes()
    ...
    ->add(match ($variant) { // Shadows...
        'primary' => 'shadow-[inset_0px_1px_var(--color-zinc-900),inset_0px_2px_--theme(--color-white/.15)] dark:shadow-none',
    ...
    ->add(match ($variant) { // Grouped border treatments...
        ...
        default => 'in-data-flux-button-group:border-r [:is([data-flux-button-group]>&:last-child,_[data-flux-button-group]_:last-child>&)]:border-r-0 in-data-flux-button-group:border-black dark:in-data-flux-button-group:border-zinc-900/25',
    })
