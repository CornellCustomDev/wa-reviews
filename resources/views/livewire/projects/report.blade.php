        ...
        <div class="col-span-1 order-first md:order-last print:hidden">
            <div class="mb-4">
                ...
                <flux:dropdown>
                    ...
                    <x-forms.menu>
                        <x-forms.menu.item icon="arrow-top-right-on-square" href="{{ route('report.google', $report) }}" target="_blank">
                            Google Sheet (requires login)
                        </x-forms.menu.item>
                        <x-forms.menu.item icon="clipboard-document" href="{{ route('report.raw', $report) }}" target="_blank">
                            Raw (for copy/paste)
                        </x-forms.menu.item>
                    </x-forms.menu>
                </flux:dropdown>
